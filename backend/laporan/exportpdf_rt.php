...
// Query untuk data transaksi bulan ini - DIBATASI OLEH RT USER
$query_transaksi = "
    SELECT
        'iuran' as tipe,
    ...
    WHERE CAST(i.bulan AS UNSIGNED) = '$bulan' AND i.tahun = '$tahun' AND i.status_pembayaran = 'Lunas' AND u.rt_number = '{$_SESSION['rt_number']}'
