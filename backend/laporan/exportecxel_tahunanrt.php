<?php
/**
 * Export Yearly Report to Excel for RT
 * File: backend/laporan/exportecxel_tahunanrt.php
 */
...
// Check login and role - MODIFIKASI: Tambahkan role RT
...
header("Content-Disposition: attachment; filename=\"Laporan_Kas_Tahunan_{$tahun}_" . date('d-m-Y') . ".xls\"");
