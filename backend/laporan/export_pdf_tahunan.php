...
try {
    ...
    header('Content-Disposition: attachment; filename="' . $tahun . '.pdf"');
    ...
    $col_widths = [40, 35, 35, 35]; // Bulan, Pemasukan, Pengeluaran, Saldo
    $table_width = array_sum($col_widths); // Total table width: 145mm
    $page_width = 210; // A4 page width in mm
    $table_x = ($page_width - $table_width) / 2; // Center position: 32.5mm
