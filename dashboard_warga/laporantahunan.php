...
$query_tahun = "
    SELECT DISTINCT tahun FROM iuran_rutin WHERE status_pembayaran = 'Lunas' AND id_warga = '$id_warga'
    UNION
    SELECT DISTINCT YEAR(pk.tanggal_pengeluaran) as tahun FROM pengeluaran_kegiatan pk LEFT JOIN user u ON pk.id_user = u.id_user WHERE u.rt_number = '$rt_number'
    ORDER BY tahun DESC
";
...
if ($tahun !== null) {
    ...
    $query_pemasukan = "
        ...
        FROM iuran_rutin
        WHERE tahun = ? AND status_pembayaran = 'Lunas' AND id_warga = '$id_warga'
    ";
    ...
    $query_pengeluaran = "
        ...
        WHERE YEAR(pk.tanggal_pengeluaran) = ? AND u.rt_number = '$rt_number'
    ";
    ...
    $query_bulanan = "
        ...
        FROM (
            SELECT bulan, jumlah_iuran as jumlah, 'pemasukan' as tipe FROM iuran_rutin WHERE tahun = ? AND status_pembayaran = 'Lunas' AND id_warga = '$id_warga'
            UNION ALL
            SELECT MONTH(pk.tanggal_pengeluaran) as bulan, pk.jumlah_pengeluaran as jumlah, 'pengeluaran' as tipe FROM pengeluaran_kegiatan pk LEFT JOIN user u ON pk.id_user = u.id_user WHERE YEAR(pk.tanggal_pengeluaran) = ? AND u.rt_number = '$rt_number'
        ) as combined
        GROUP BY bulan
        ORDER BY bulan
    ";
