...
// Ambil rt_number dari session
$rt_warga = $_SESSION['rt_number'] ?? '';

// Jika tidak ada rt_number, redirect
if (!$rt_warga) {
    header("Location: ../auth/login.php");
    exit();
}

// Query untuk mengambil data pengeluaran berdasarkan RT yang sama (semua pengeluaran dari RT tersebut)
$query = "SELECT pk.*, u.username as diajukan_oleh, u.rt_number
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Export button functionality (untuk desktop dan mobile)
    ...
    exportBtns.forEach(btn => {
        btn.addEventListener('click', function() {
            ...
            let url = '../backend/pengeluaran/export_pengeluaran_warga.php?';
            const params = [];
