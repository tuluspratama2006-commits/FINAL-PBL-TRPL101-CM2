    ...
    if ($id_user) {
        ...
        try {
            ...
            $query_update_warga = "UPDATE warga SET
                                  ...
                                  updated_at = NOW()
                                  WHERE id_warga = (SELECT id_warga FROM user WHERE id_user = '$id_user')";
        ...
        $error_profil = "ID user tidak ditemukan!";
    }
}
...
<head>
    ...
    <title>Pengaturan RT - Aplikasi Web Keuangan RT/RW Digital</title>
...
<div class="main-content">
    ...
    <div class="topbar">
        <div>
            <h5 class="fw-bold mb-0">Pengaturan RT</h5>
...
document.getElementById('notificationForm').addEventListener('submit', function(e) {
    ...
    fetch('../backend/notifications/save_notification_preferences.php', {
        method: 'POST',
        body: formData
    })
    ...
    .catch(error => {
        ...
        alertDiv.style.display = 'block';
        alertDiv.className = 'alert alert-danger';
        alertDiv.innerHTML = '<i class="bi bi-exclamation-circle"></i> Terjadi kesalahan saat menyimpan preferensi';
