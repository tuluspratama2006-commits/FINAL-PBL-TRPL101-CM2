...
$query = "SELECT pk.*,
          COALESCE(w.nama_lengkap, u.username) as diajukan_oleh
...
<head>
    ...
    <title>Pengeluaran - Bendahara - AKURAD.APP</title>
...
<div class="main-content" id="mainContent">
    ...
    <div class="topbar d-none d-md-flex mb-2">
        ...
        <div class="top-bar-right ms-auto">
            <div class="d-flex gap-3">
                ...
                <button class="btn btn-input" data-bs-toggle="modal" data-bs-target="#modalTambahPengeluaran" style="width: 200px;">
                    Input Pengeluaran
                </button>
            </div>
        </div>
    ...
    <div class="filter-section">
        ...
        <div class="d-flex d-md-none gap-2 mt-3">
            ...
            <button class="btn btn-input flex-grow-1" data-bs-toggle="modal" data-bs-target="#modalTambahPengeluaran">
                Input Pengeluaran
            </button>
        </div>
    </div>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <button class="btn-action-simple" onclick="deleteExpense(<?= $expense['id_pengeluaran'] ?>)" style="color: #dc3545;">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Input Pengeluaran Baru</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
            </div>
            <form method="POST" action="../backend/pengeluaran/tambah_pengeluaran.php" enctype="multipart/form-data">
                <div class="modal-body">
                    <p class="text-muted mb-4">Tambah data pengeluaran RT/RW</p>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control" id="deskripsi" name="deskripsi" rows="3" placeholder="Jelaskan pengeluaran ini..." required></textarea>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <div class="input-group">
                            ...
                            <input type="number" class="form-control" id="jumlah" name="jumlah" value="0" min="0" required>
                        </div>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="diajukan_oleh" name="diajukan_oleh"
                            value="<?php echo $_SESSION['nama'] ?? $_SESSION['username']; ?>" readonly>
                    </div>
...
function deleteExpense(id) {
    if (confirm('Apakah Anda yakin ingin menghapus data pengeluaran ini?')) {
        window.location.href = '../backend/pengeluaran/hapus_pengeluaran.php?id=' + id;
    }
}
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (exportBtn) {
        exportBtn.addEventListener('click', function() {
            window.location.href = '../backend/pengeluaran/export_pengeluaran.php';
        });
    }
