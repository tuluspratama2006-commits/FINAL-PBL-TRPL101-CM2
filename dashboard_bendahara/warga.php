...
// Query untuk mengambil data warga dengan join ke user - BENDAHARA MELIHAT SEMUA RT
$query = "
SELECT
    u.id_user,
    u.username,
...
// Hitung statistik berdasarkan RT dan role secara dinamis - BENDAHARA MELIHAT SEMUA RT
$query_stats = "SELECT rt_number, role, COUNT(*) as count FROM user GROUP BY rt_number, role ORDER BY rt_number, role";
                    ...
                    <tr>
                        ...
                        <td>
                            <span class="badge
                                <?php echo $w['role'] === 'RT' ? 'bg-primary' :
                                        ($w['role'] === 'Bendahara' ? 'bg-warning text-dark' : 'bg-secondary'); ?>" data-role="<?php echo strtolower($w['role'] ?? 'warga'); ?>">
                        ...
                        <td>
                            <div class="action-buttons">
                                ...
                                <form action="../backend/warga/hapus_warga.php" method="POST" style="display:inline;">
...
<div class="modal-overlay" id="modalTambah">
    <div class="modal-content">
        ...
        <div class="modal-body">
            <form action="../backend/warga/tambah_warga.php" method="POST" id="formTambahWarga">
                ...
                <div class="form-group">
                    ...
                    <div class="grid-2col">
                        <div>
                            <input type="hidden" name="rt_number" value="<?php echo htmlspecialchars($user_rt); ?>">
                            <input type="text" class="form-control" value="<?php echo htmlspecialchars($user_rt); ?>" readonly>
                        </div>

                        <div>
                            <select name="role" class="form-control select-dropdown" required>
...
<div class="modal-overlay" id="modalEdit">
    <div class="modal-content">
        ...
        <div class="modal-body">
            <form action="../backend/warga/edit_warga.php" method="POST" id="formEditWarga">
                ...
                <div class="form-group">
                    <div class="grid-2col">
                        <div>
                            <label>RT</label>
                            <input type="hidden" name="rt_number" id="edit_rt_hidden" value="<?php echo htmlspecialchars($user_rt); ?>">
                            <input type="text" class="form-control" id="edit_rt_display" value="<?php echo htmlspecialchars($user_rt); ?>" readonly>
                        </div>
    ...
    async function openEditWarga(id) {
        try {
            ...
            document.getElementById('edit_rt_hidden').value = data.rt || '';
            document.getElementById('edit_rt_display').value = data.rt || '';
    ...
    function filterTable() {
        ...
        rows.forEach(row => {
            ...
            const roleElement = row.cells[3]?.querySelector('.badge');
            const role = roleElement?.getAttribute('data-role')?.toLowerCase() || '';
    ...
    function validateTambahForm() {
        ...
        if (!/^[a-zA-Z0-9_]{3,50}$/.test(username)) {
            showFieldError('username', 'Username 3-50 karakter (huruf, angka, underscore)');
            isValid = false;
        }
        ...
        // Validate RT
        const rt = form.querySelector('select[name="rt_number"]').value;
        if (!rt) {
            showFieldError('rt_number', 'Pilih RT terlebih dahulu');
            isValid = false;
        }
