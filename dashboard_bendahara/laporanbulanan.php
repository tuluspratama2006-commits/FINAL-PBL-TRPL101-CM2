...
$query_iuran = "
    ...
    WHERE CAST(i.bulan AS UNSIGNED) = ? AND i.tahun = ? AND i.status_pembayaran = 'Lunas'
";
...
<body>
    ...
    <script>
        ...
        document.getElementById('exportExcelBtn').addEventListener('click', function() {
            ...
            const exportUrl = `../backend/laporan/export_laporan_excel.php?bulan=${bulan}&tahun=${tahun}`;
        ...
        document.getElementById('exportPdfBtn').addEventListener('click', function() {
            const bulan = document.getElementById('bulanSelect').value || '<?php echo $bulan; ?>';
            const tahun = document.getElementById('tahunSelect').value || '<?php echo $tahun; ?>';
            const exportUrl = `../backend/laporan/export_laporan_pdf.php?bulan=${bulan}&tahun=${tahun}`;
            window.open(exportUrl, '_blank');
        });
